...
namespace ContractCompile.Contracts.SolarToken
{
    public partial class SolarTokenService: SolarTokenServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, SolarTokenDeployment solarTokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<SolarTokenDeployment>().SendRequestAndWaitForReceiptAsync(solarTokenDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, SolarTokenDeployment solarTokenDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<SolarTokenDeployment>().SendRequestAsync(solarTokenDeployment);
        }

        public static async Task<SolarTokenService> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, SolarTokenDeployment solarTokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, solarTokenDeployment, cancellationTokenSource);
            return new SolarTokenService(web3, receipt.ContractAddress);
        }

        public SolarTokenService(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class SolarTokenServiceBase: ContractWeb3ServiceBase
    {

        public SolarTokenServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
